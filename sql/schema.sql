CREATE TABLE IF NOT EXISTS customers (
    ...
    -- Reduced name length to a more practical size
...
CREATE TABLE IF NOT EXISTS addresses (
    ...
    -- Split address into two lines for better flexibility
    address_line1 VARCHAR(255) NOT NULL,
    address_line2 VARCHAR(255),

    city VARCHAR(100),

    -- Renamed state to state_name and added state_code
    state_name VARCHAR(100),
    state_code VARCHAR(10),

    country VARCHAR(100),

    -- Kept country_code for shipping label standardization
...
CREATE TABLE IF NOT EXISTS shipments (
    ...
    -- Validation status stored in the main table instead of a separate invalid table
